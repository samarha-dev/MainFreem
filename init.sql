-- ============================================================
--  MainFreem — Script d'initialisation PostgreSQL
--  Tables utilisées pour les exercices COBOL SQL (ex. 10-12)
-- ============================================================

-- ── Table EMPLOYES (exercices 10, 11, 12, 13) ──────────────
CREATE TABLE IF NOT EXISTS employes (
    ...
    statut      CHAR(1)        NOT NULL DEFAULT 'A'  -- A=Actif, I=Inactif
);

-- ── Table SERVICES (exercice 13) ───────────────────────────
...
-- ── Table EMPLOYES_CHARGES (exercice 13 — ETL) ─────────────
CREATE TABLE IF NOT EXISTS employes_charges (
    ...
    salaire_charge  DECIMAL(10,2)  NOT NULL DEFAULT 0.00  -- salaire * 1.42
);
...
-- ── Vue utilitaire : masse salariale par service ────────────
...
DO $$
BEGIN
    RAISE NOTICE '✅ Base coboldb initialisée avec succès.';
    RAISE NOTICE '   Tables : employes (%), services (%), employes_charges',
